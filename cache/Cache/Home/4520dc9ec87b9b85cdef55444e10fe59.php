									...
									<ul class="main_form">
										<span id="mail_box">
											...
											<li>
												...
												<div class="fm_right">
													<input type="text" value="" class="input" name="mobile" id="phone"/>
													<span style="display:none" class="right_img" id="phone_right"></span><span id="phoneTips" style="display:none"></span><span style="display:none" id="phone_err"> <span class="err_left"></span> <span class="err_info"> <span class="err_mid" ><span class="err_img1"></span><em></em></span></span> <div class="clear"></div> </span>
												</div>
											</li>
											<li>
												<div class="fm_left">
												...
												<div class="fm_right">
													...
													<select  id="city" class="s_select" name="city" onchange="citychange()">
														<option value="null">市 请选择</option>
													</select>
													<select  id="area" class="s_select" name="area"  onchange="areachange()">
														<option value="null">县/区 请选择</option>
													</select>
													<select name="location" class="s_select" id="location" >
														<option value="null">范围 请选择</option>
													</select>
											...
											<li>
												...
												<div class="fm_right">
													<input type="text" value="" class="input" name="extra_address" id="address"/>
													<span style="display:none" class="right_img" id="address_right"></span><span id="addressTips" style="display:none"></span><span style="display:none" id="address_err"> <span class="err_left"></span> <span class="err_info"> <span class="err_mid" ><span class="err_img1"></span><em></em></span></span> <div class="clear"></div> </span>
												</div>
											</li>
