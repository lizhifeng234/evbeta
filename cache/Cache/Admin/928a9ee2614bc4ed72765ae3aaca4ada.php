...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	购物中心 - 列表
		...
		<link href="/evbeta/__PUBLIC__/css/web/dialogBox.css" rel="stylesheet" type="text/css" />
		...
		<link href="/evbeta/__PUBLIC__/css/web/mall/mall_list.css" rel="stylesheet" type="text/css" />
...
<div class="pg_w">
	<div class="header_t">
		...
		<div class="search_menu">
			...
			<span class="dfr">
				<select class="sale-ui-select" name='searchType' id='searchType'>
...
<div class="header_b w1">
	...
	<script type="text/javascript" src="http://static.soulagou.com/js/base/jquery-custom-base.js"></script>
	<script type="text/javascript" src="http://static.soulagou.com/js/plugin/sale-ui-select.js"></script>
	<script type="text/javascript" src="http://static.soulagou.com/js/www-web/alone/www_web.js"></script>
	<script type="text/javascript" src="http://static.soulagou.com/js/www-web/alone/user_info.js"></script>
	<script type="text/javascript" src="http://static.soulagou.com/js/plugin/sale-ui-scrollTitleProxy.js"></script>
	...
	<script type="text/javascript"
		src="js/mall_list.js"></script>

	
	<script type="text/javascript">
		jQ.WWWServerWeb.init();
		jQ('.sale-ui-select').defaultSelect();
