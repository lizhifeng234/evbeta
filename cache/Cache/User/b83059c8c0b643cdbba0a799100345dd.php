				...
				<div id="header">
					<div class="pg_w">
						...
						<div class="pdt11 pdl10">
							<a href="http://sso.soulagou.com/login?service=http://www.soulagou.com/j_client_security_check"> <img src="http://static.soulagou.com/img/outlet_manager/header_logo.png" /> </a>
						</div>
						<div class="clear"></div>
					</div>
				</div><!--这里放页头 end--></td>
...
<ul class="menu_list01">
		...
		<li class="on"><a href="/evbeta/User/Storer/store">店铺设置<em></em></a></li>
											...
											<div class="in imageViewPanel">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														</div><div class="fsUploadProgress"></div><!-- 上传图片 --><a href="javascript:void(0)" class="spanButtonPlaceholder update_l update_l_yc" id="spanButtonPlaceholder"></a>
														...
														<td class="shuom"> 建议尺寸350*200px，图片小于2M，支持jpg、jpeg、png、bmp格式图片。 </td>
													</tr>
												</table>
											</div>
										</div></td>
	...
	<script type="text/javascript">
		...
		jQ("#accordion").togglepanels({
			open : [0],
			select : jQ("#accordion").find('li').eq(2)
		});
	</script>
