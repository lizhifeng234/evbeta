<?php if (!defined('THINK_PATH')) exit();?><<<<<<< .mine
=======
...
<link href="http://static.soulagou.com/css/plugin/TogglePanels.css" rel="stylesheet" type="text/css" />
	...
	<link href="http://static.soulagou.com/css/outlet_manager/alone/pub_news.css" rel="stylesheet" type="text/css" />
...
<form id="newsFormBean" action="add" method="POST">
		<div class="r_w">
			...
			<table class="r_col_t01" width="100%" border="0" cellspacing="0"
				cellpadding="0">
