...
<form method="post" name="Logon" action="__URL__/blogin" id="Logon">

<div class="form clearfix">
<dl>
<dt>用户名：</dt>
<dd>
<input name="username" id="username" type="text" class="uiText" style="color:#999;" tabindex="1" autocomplete="off"/>
