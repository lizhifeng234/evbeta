...
<link href="http://static.soulagou.com/css/plugin/TogglePanels.css" rel="stylesheet" type="text/css" />
	...
	<link href="http://static.soulagou.com/css/global.css" rel="stylesheet" type="text/css" />
	<link href="http://static.soulagou.com/css/outlet_manager/alone/list_news.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="http://static.soulagou.com/js/plugin/TogglePanels.js"></script>
	...
	<script type="text/javascript" src="http://static.soulagou.com/js/backend_manager/alone/delete.js"></script>
		...
		<div class="r_w">
			...
			<div class="mgt30">
				<div class="dfl dfl_title01">
					<a href="/outlet/promotional/add" class="on">发布优惠活动</a>
				</div>
				<div class="clear"></div>
			</div>
			<div class="m_col_div">
				<table class="m_col_table" width="100%" border="0" cellspacing="0"
					...
					<tr>
						...
						<th class="last_r">操作</th>
							...
							<tr>
								<td colspan="2">
									<p class="ticket_title oflp" style="text-align: center;" >暂无优惠活动</p>
								</td>
							</tr>
