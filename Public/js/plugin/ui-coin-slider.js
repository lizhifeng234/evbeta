...
(function ($) {
	...
	$.fn.coinslider = $.fn.CoinSlider = function (options) {
		...
		var setNavigation = function (el) {
			...
			$('#cs-navigation-' + el.id).append("<a href='#' id='cs-prev-" + el.id + "' class='cs-prev ader_btn ader_btnbg_l'>"+params[el.id].prevText+"</a>");
			$('#cs-navigation-' + el.id).append("<a href='#' id='cs-next-" + el.id + "' class='cs-next ader_btn ader_btnbg_r'>"+params[el.id].nextText+"</a>");
			$('#cs-prev-' + el.id).css({
				'position'		: 'absolute',
		...
		var init = function (el) {
			...
			//���û��IMG���󣬴���һ���ٵġ�
			if(!$('#' + el.id + ' img').length > 0)
				$('#' + el.id).append('<img src="'+params[el.id].nullImgUrl+'" />')
	...
	$.fn.coinslider.defaults = {
		...
		prevText: '',
//		nullImgUrl:'../../img/www-web/defa_busiv.jpg',
		nextText: ''
	};
